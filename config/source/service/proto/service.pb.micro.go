...
// NewConfigEndpoints API Endpoints for Config service
func NewConfigEndpoints() []*api.Endpoint {
	return []*api.Endpoint{}
}

// ConfigService is the client API for Config service.
...
// ConfigHandler is the server API for Config service.
