...
// NewClientEndpoints API Endpoints for Client service
func NewClientEndpoints() []*api.Endpoint {
	return []*api.Endpoint{}
}

// ClientService is the client API for Client service.
...
// ClientHandler is the server API for Client service.
