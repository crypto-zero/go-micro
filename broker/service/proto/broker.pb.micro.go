...
// NewBrokerEndpoints API Endpoints for Broker service
func NewBrokerEndpoints() []*api.Endpoint {
	return []*api.Endpoint{}
}

// BrokerService is the client API for Broker service.
...
// BrokerHandler is the server API for Broker service.
