...
import (
	...
	"github.com/crypto-zero/go-micro/v2/api/handler/rpc"
	"github.com/crypto-zero/go-micro/v2/api/router"
	rregistry "github.com/crypto-zero/go-micro/v2/api/router/registry"
	rstatic "github.com/crypto-zero/go-micro/v2/api/router/static"
